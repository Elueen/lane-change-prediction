...
logging.basicConfig(filename="logs/7_12_320.txt", level=logging.INFO)
...
model = LPGRU(input_size=9, hidden_size=64, output_size=3, num_layers=num_layers, sequence_size=sequence_size)
