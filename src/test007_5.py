...
model = LSTMNet(input_size=9, hidden_size=64, output_size=1, num_layers=num_layers)
...
if __name__ == "__main__":
    ...
    model.eval()
    # initial_h_state = torch.zeros(num_layers, batch_size, hidden_size).to(device)
    # initial_c_state = torch.zeros(num_layers, batch_size, hidden_size).to(device)
