...
model = LPLSTM(input_size=9, hidden_size=64, output_size=3, num_layers=num_layers, sequence_size=sequence_size)
...
torch.save(model.state_dict(), "Models/save/514.pth")
